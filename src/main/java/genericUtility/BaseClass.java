...
public class BaseClass {
	...
	//sets the current threads copy of this thread-local variable to the specified value
	public static void setDriver(WebDriver driver)
	{
		driverInstance.set(driver);
	}
	//Returnds the value in the current threads copy of this thread-local variable
